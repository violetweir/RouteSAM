"""A2 seed2026 ablation: original1008, restored LR5e-5 cosine, NO gradient clipping."""
...
def main():
    ...
    d.save(D/'status.json', dict(stage='initializing', arm='A2_restored_lr_no_clip_'+arm, gpu=d.args.gpu))
    ...
    for epoch in range(1,11):
        ...
        for j,batch in enumerate(loader):
            ...
            if j==0 or step%20==0:
                status=dict(stage='training',arm='A2_restored_lr_no_clip_'+arm,epoch=epoch,epochs=10,epoch_step=j+1,epoch_size=expected_count,
    ...
    d.save(D/'results.json',dict(arm='A2_restored_lr_no_clip_'+arm,best_epoch=best_epoch,validation=best,test=result,test_empty=empty_result,training_pool_size=expected_count,
