...
import direct_eval_original1008 as d

def main():
    dest = d.R / 'audits/A1_epoch3_original1008_test'
    ...
    d.save(dest / 'AUDIT_FROZEN.json', dict(
        ...
        validation_effective256_reference=val, reason='User requested original image directly resized to 1008 without intermediate 256',
        role='diagnostic; does not change validation-based final checkpoint selection',
        protocol='single image, colon polyp, original image directly resized to 1008; metrics256, no points/boxes/TP/Router/B7',
