...
R=Path('/Data_8TB/lht/PseudoVideo-SAM3-X3-B7/new_project/reproduction_guides/automatic_selection_20260914/verify_router_kvasir_isic')
MODE='sam3enc_anchor_conditioned_target_pooling'
SOURCES={'kvasir':'auto8_tp_validation_20260911','isic2018':'isic2018_auto21_tp_validation_20260911'}
...
spec=importlib.util.spec_from_file_location('legacy',E/SOURCES['kvasir']/'code/router.py');legacy=importlib.util.module_from_spec(spec);spec.loader.exec_module(legacy)
...
def run():
 ...
 for name,source in SOURCES.items():
  ...
  vf=E/source/f'quality_root/{MODE}/propagation_quality_validation/propagation_quality.jsonl';tf=T/name/f'quality_root/{MODE}/propagation_quality_test/propagation_quality.jsonl'
  ...
  mf=T/name/'automatic/per_candidate_metrics.json';metricrows=json.loads(mf.read_text());metrics={r['route_id']:r for r in metricrows}
