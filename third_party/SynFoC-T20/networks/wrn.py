...
class WideResNet(nn.Module):
    def __init__(self, in_channel, depth, num_classes, widen_factor=1, bn_momentum=0.1, leaky_slope=0.0, dropRate=0.0):
...
class build_WideResNet:
    ...
    def build(self, num_classes, in_channel):
        return WideResNet(in_channel=in_channel,
                          depth = self.depth,
